...
**"Elastic Scale-Out on a Budget"** — Demonstrating horizontal scaling of LLM inference across multiple GPU nodes using RHOAI 3.3's llm-d (Distributed Inference) capability.
...
> - [RHOAI 3.3: Configuring authentication for Distributed Inference with llm-d using RHCL](https://docs.redhat.com/en/documentation/red_hat_openshift_ai_self-managed/3.3/html-single/deploying_models/index#configuring-authentication-for-llmd_rhoai-user)
...
**Success criteria:**
- A distributed model deployment is created using the **RHOAI 3.3 GA supported flow**
...
> **Official explanation:** [RHOAI 3.3: Deploying models by using Distributed Inference with llm-d](https://docs.redhat.com/en/documentation/red_hat_openshift_ai_self-managed/3.3/html-single/deploying_models/index#deploying-models-using-distributed-inference_rhoai-user)
...
This is **expected behavior** per RHOAI 3.3 — llm-d uses the alpha API and is managed exclusively via CLI/GitOps.
...
| Gateway API configured | ✅ | RHOAI 3.3 (automatic) |
...
>
> After installing RHCL, **restart the RHOAI controllers** per [RHOAI 3.3 docs](https://docs.redhat.com/en/documentation/red_hat_openshift_ai_self-managed/3.3/html-single/deploying_models/index#deploying-models-using-distributed-inference_rhoai-user):
> ```bash
> oc delete pod -n redhat-ods-applications -l app=odh-model-controller
> oc delete pod -n redhat-ods-applications -l control-plane=kserve-controller-manager
> ```
>
> **Ref:** [RHOAI 3.3: Configuring authentication for llm-d using RHCL](https://docs.redhat.com/en/documentation/red_hat_openshift_ai_self-managed/3.3/html-single/deploying_models/index#configuring-authentication-for-llmd_rhoai-user)
...
> [RHOAI 3.3: Intelligent inference scheduler with KV cache routing](https://docs.redhat.com/en/documentation/red_hat_openshift_ai_self-managed/3.3/html-single/deploying_models/index#intelligent_inference_scheduler_with_kv_cache_routing)
...
> [RHOAI 3.3: Example usage — Multi-node deployment](https://docs.redhat.com/en/documentation/red_hat_openshift_ai_self-managed/3.3/html-single/deploying_models/index#multi_node_deployment)
...
RHOAI 3.3 documentation references (and llm-d validates) a Gateway named `openshift-ai-inference` in the `openshift-ingress` namespace.
...
- `VLLM_USE_V1: "1"` — Required for RHOAI 3.3
...
- **Deploying models (llm-d)**:
  - [RHOAI 3.3: Deploying models by using Distributed Inference with llm-d](https://docs.redhat.com/en/documentation/red_hat_openshift_ai_self-managed/3.3/html-single/deploying_models/index#deploying-models-using-distributed-inference_rhoai-user)
  - [RHOAI 3.3: Configuring authentication for llm-d using Red Hat Connectivity Link](https://docs.redhat.com/en/documentation/red_hat_openshift_ai_self-managed/3.3/html-single/deploying_models/index#configuring-authentication-for-llmd_rhoai-user)
  - [RHOAI 3.3: Enabling Distributed Inference with llm-d](https://docs.redhat.com/en/documentation/red_hat_openshift_ai_self-managed/3.3/html-single/deploying_models/index#enabling-distributed-inference_rhoai-user)
  - [RHOAI 3.3: Example usage — Single-node GPU deployment](https://docs.redhat.com/en/documentation/red_hat_openshift_ai_self-managed/3.3/html-single/deploying_models/index#single_node_gpu_deployment)
  - [RHOAI 3.3: Example usage — Multi-node deployment](https://docs.redhat.com/en/documentation/red_hat_openshift_ai_self-managed/3.3/html-single/deploying_models/index#multi_node_deployment)
  - [RHOAI 3.3: Example usage — Intelligent inference scheduler with KV cache routing](https://docs.redhat.com/en/documentation/red_hat_openshift_ai_self-managed/3.3/html-single/deploying_models/index#intelligent_inference_scheduler_with_kv_cache_routing)
- **Release notes**:
  - [RHOAI 3.3: New features and enhancements](https://docs.redhat.com/documentation/red_hat_openshift_ai_self-managed/3.3/html/release_notes/new-features-and-enhancements_relnotes)
  - [RHOAI 3.3: Release notes (index)](https://docs.redhat.com/en/documentation/red_hat_openshift_ai_self-managed/3.3/html-single/release_notes/index)
...
> This CRD is **Developer Preview** and not available in RHOAI 3.3 GA installations.
...
> **Status:** Developer Preview in RHOAI 3.3 GA
...
**References:**
- [RHOAI 3.3 Release Notes - Developer Preview Features](https://docs.redhat.com/en/documentation/red_hat_openshift_ai_self-managed/3.3/html/release_notes/index)
...
> **Note**: This step is part of the RHOAI 3.3 demo series. The distributed inference feature requires RHOAI 3.3 GA and proper Gateway API configuration.
