...
> **Note (RHOAI 3.3):** When step-11 is NOT deployed, both LSDs will log connection warnings for `FMS_ORCHESTRATOR_URL` but inference and RAG work normally. Shields activate only when the Orchestrator is running.
