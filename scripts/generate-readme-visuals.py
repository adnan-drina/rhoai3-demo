...
ROWS = (
    Row(
        ...
        caps=(
            ...
            Capability("model-evaluation", "step-08-model-evaluation", ("Model evaluation", "and benchmarking")),
    ...
    Row(
        ...
        caps=(
            ...
            Capability("ai-guardrails", "step-09-guardrails", ("AI guardrails", "and safety")),
            Capability("mcp-tools", "step-10-mcp-integration", ("MCP tool", "integration")),
    ...
    Row(
        id="pipelines-ops",
        product="openshift_ai",
        label=("Pipelines", "and model", "operations"),
        y=630,
        h=170,
        cols=3,
        caps=(
    ...
    Row(
        id="gpu-self-service",
        product="openshift_ai",
        label=("GPU", "acceleration", "self-service"),
        y=825,
        h=150,
        cols=4,
        caps=(
            ...
            Capability("self-service-gpu", "step-03-private-ai", ("Self-service", "GPU access")),
            Capability("gpu-capacity-metrics", "step-06-model-metrics", ("GPU telemetry", "and capacity")),
        ),
    ),
    Row(
