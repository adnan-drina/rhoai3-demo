...
| EvalHub and Evaluation Stack | Evaluation | Decide whether to deploy EvalHub now or explicitly mark it as next-wave. Step 08 now has MLflow tracking for the custom RAG KFP path; EvalHub remains the preferred product-native follow-up for RAGAS/Garak/GuideLLM jobs. | Step 08 has MLflow-backed custom evaluation evidence today and either gains EvalHub or keeps a clear deferral with official references. |
