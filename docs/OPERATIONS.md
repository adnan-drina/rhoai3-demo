...
- `stage-230-private-data-rag/scripts/dutch_publication_prepare.py` prepares
  article-level records from the Dutch PDF metadata contract. Its supported
...
Run the Dutch publication data-preparation contract:
