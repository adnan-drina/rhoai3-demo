...
GENERATION_MODELS_JSON="${RHOAI_STAGE230_AUTORAG_GENERATION_MODELS_JSON:-[\"vllm-inference/${RHOAI_MAAS_NEMOTRON_MODEL_NAME:-nemotron-3-nano-30b-a3b}\",\"vllm-gpt/${RHOAI_STAGE230_MAAS_GPT_MODEL_NAME:-gpt-4o-mini}\"]}"
EMBEDDINGS_MODELS_JSON="${RHOAI_STAGE230_AUTORAG_EMBEDDINGS_MODELS_JSON:-[\"vllm-granite/granite-embedding-30m\",\"vllm-minilm/all-minilm-l6-v2\"]}"
