...
| **Evaluation** | EvalHub Technology Preview control plane, repeatable model benchmarks, and RAG quality evidence before production use. | Step 08 |
...
| 08 | [Model Evaluation](steps/step-08-model-evaluation/README.md) | EvalHub [TP] control plane, pre/post RAG eval (LLM-as-Judge), LM-Eval benchmarks | [Evaluate LLMs with EvalHub](https://docs.redhat.com/en/documentation/red_hat_openshift_ai_self-managed/3.4/html/evaluating_ai_systems/evaluating-llms-with-evalhub_evaluate) |
