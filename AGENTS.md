...
The active implementation has been rebuilt stage by stage. Legacy
implementation artifacts were removed from the working tree; they remain
accessible in git history if needed (`git log --all -- backup/`).
