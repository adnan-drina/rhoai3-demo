...
| OpenShift Data Foundation | `odf-*` | ODF baseline pinned; core component skills planned next with `project-red-hat-doc-skill-authoring` | Official-doc-backed OpenShift Data Foundation storage, object storage, Ceph, NooBaa, storage class, and data-service integration guidance |
