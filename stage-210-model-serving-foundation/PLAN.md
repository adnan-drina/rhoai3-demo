...
| `gitops/argocd/app-of-apps/stage-210-model-serving-foundation.yaml` | `Application` | Project Argo CD standards | `oc get applications.argoproj.io stage-210-model-serving-foundation -n openshift-gitops` |
